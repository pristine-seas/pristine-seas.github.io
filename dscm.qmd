...
all_dscm_deployments |> 
  select(expedition_name, ps_site_id, location, deployment_time_utc, deployment_lon, deployment_lat, max_depth_m, recording_time) |> 
  write_csv("~/Desktop/pristine_seas_dscm_deployments.csv")
```
